...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("DataDataSet43"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class DataDataSet43
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As DataDataSet43 = CType(MyBase.Clone,DataDataSet43)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "DataDataSet43"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/DataDataSet43.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As DataDataSet43 = New DataDataSet43()
    ...
    Partial Public Class salesDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Overloads Function AddsalesRow(ByVal Name As String, ByVal PhNumber As String, ByVal Product As String, ByVal Quantity As String, ByVal Total_Price As String, ByVal _Date As Date) As salesRow
            Dim rowsalesRow As salesRow = CType(Me.NewRow,salesRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, Name, PhNumber, Product, Quantity, Total_Price, _Date}
...
Namespace DataDataSet43TableAdapters
    ...
    Partial Public Class salesTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[sales] WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Na"& _ 
                "me) AND ([PhNumber] = @Original_PhNumber) AND ([Product] = @Original_Product) AN"& _ 
                "D ([Quantity] = @Original_Quantity) AND ([Total_Price] = @Original_Total_Price) "& _ 
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[sales] ([Name], [PhNumber], [Product], [Quantity], [Total_Pric"& _ 
                "e], [Date]) VALUES (@Name, @PhNumber, @Product, @Quantity, @Total_Price, @Date);"& _ 
                ""&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Id, Name, PhNumber, Product, Quantity, Total_Price, Date FROM sales WHE"& _ 
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[sales] SET [Name] = @Name, [PhNumber] = @PhNumber, [Product] = @Pro"& _ 
                "duct, [Quantity] = @Quantity, [Total_Price] = @Total_Price, [Date] = @Date WHERE"& _ 
                " (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([PhNumber] = @Origina"& _ 
                "l_PhNumber) AND ([Product] = @Original_Product) AND ([Quantity] = @Original_Quan"& _ 
                "tity) AND ([Total_Price] = @Original_Total_Price) AND ([Date] = @Original_Date))"& _ 
                ";"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Id, Name, PhNumber, Product, Quantity, Total_Price, Date FROM sales WH"& _ 
                "ERE (Id = @Id)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Id, Name, PhNumber, Product, Quantity, Total_Price, Date FROM dbo.sales"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As DataDataSet43.salesDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As DataDataSet43.salesDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As DataDataSet43.salesDataTable = New DataDataSet43.salesDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As DataDataSet43.salesDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As DataDataSet43) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Id As Integer, ByVal Original_Name As String, ByVal Original_PhNumber As String, ByVal Original_Product As String, ByVal Original_Quantity As String, ByVal Original_Total_Price As String, ByVal Original_Date As Date) As Integer
            ...
            Else
                Me.Adapter.DeleteCommand.Parameters(5).Value = CType(Original_Total_Price,String)
            End If
        ...
        Public Overloads Overridable Function Insert(ByVal Name As String, ByVal PhNumber As String, ByVal Product As String, ByVal Quantity As String, ByVal Total_Price As String, ByVal _Date As Date) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal Name As String, ByVal PhNumber As String, ByVal Product As String, ByVal Quantity As String, ByVal Total_Price As String, ByVal _Date As Date, ByVal Original_Id As Integer, ByVal Original_Name As String, ByVal Original_PhNumber As String, ByVal Original_Product As String, ByVal Original_Quantity As String, ByVal Original_Total_Price As String, ByVal Original_Date As Date, ByVal Id As Integer) As Integer
            If (Name Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Name")
            Else
            ...
            If (Original_PhNumber Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_PhNumber")
            Else
                Me.Adapter.UpdateCommand.Parameters(8).Value = CType(Original_PhNumber,String)
            End If
            If (Original_Product Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_Product")
            Else
            ...
            If (Original_Total_Price Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_Total_Price")
            Else
                Me.Adapter.UpdateCommand.Parameters(11).Value = CType(Original_Total_Price,String)
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal Name As String, ByVal PhNumber As String, ByVal Product As String, ByVal Quantity As String, ByVal Total_Price As String, ByVal _Date As Date, ByVal Original_Id As Integer, ByVal Original_Name As String, ByVal Original_PhNumber As String, ByVal Original_Product As String, ByVal Original_Quantity As String, ByVal Original_Total_Price As String, ByVal Original_Date As Date) As Integer
            Return Me.Update(Name, PhNumber, Product, Quantity, Total_Price, _Date, Original_Id, Original_Name, Original_PhNumber, Original_Product, Original_Quantity, Original_Total_Price, Original_Date, Original_Id)
        End Function
    End Class
    ...
    Partial Public Class TableAdapterManager
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As DataDataSet43, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Private Function UpdateInsertedRows(ByVal dataSet As DataDataSet43, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._salesTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Private Function UpdateDeletedRows(ByVal dataSet As DataDataSet43, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._salesTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Overridable Function UpdateAll(ByVal dataSet As DataDataSet43) As Integer
